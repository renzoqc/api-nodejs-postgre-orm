...
var typeorm_1 = require("typeorm"); // conectarnos a una tabla de base de datos
...
var getUser = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, (0, typeorm_1.getRepository)(User_1.User).findOne({ id: req.params.id })];
            case 1:
                results = _a.sent();
